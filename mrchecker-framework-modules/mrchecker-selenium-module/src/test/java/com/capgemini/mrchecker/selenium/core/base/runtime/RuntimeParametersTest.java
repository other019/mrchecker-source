...
public class RuntimeParametersTest {
	...
	public void setUp() throws Exception {
		...
		values.put("browserSize", "800x600");
		...
		RuntimeParametersSelenium.BROWSER_SIZE.refreshParameterValue();
	}
	...
	public void testGetProperty() {
		...
		assertThat("System parameters for empty property 'browserSize' should be '800x600'", RuntimeParametersSelenium.BROWSER_SIZE.getValue(), Matchers.equalTo("800x600"));
	...
	public void testGetEmptyProperty() {
		...
		assertThat("System parameters for empty property 'browserSize' should be 'null'", RuntimeParametersSelenium.BROWSER_SIZE.getValue(), Matchers.isEmptyString());
