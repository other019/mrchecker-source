...
public class ResolutionUtils {
	...
	/**
	 * of browser to width and height specified by parameter resolutionString filled with value like widthxhight
	 *
	 * @param resolutionString
	 */
	public static void setResolution(INewWebDriver driver, String resolutionString) {

		String[] browser_size = resolutionString.split("x");
		Dimension resolution = new Dimension(Integer.parseInt(browser_size[0]), Integer.parseInt(browser_size[1]));
		setResolution(driver, resolution);
